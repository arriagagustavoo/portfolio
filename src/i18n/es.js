export default {
    ...
    services: {
        ...
        closing: {
            text: "¿Necesitas algo que no está en la lista?",
            link: "Dime qué necesitas",
        },
        packageRows: [
            "Hecho a la medida de tu marca",
            "Funciona en celular y computadora",
            "Formulario de contacto que llega directo a tu correo",
            "Preparado para que Google lea los datos de tu negocio",
            "Páginas privadas a las que solo tú entras, para reservaciones, pedidos y mensajes",
            "Tu propia base de datos, para que el sitio guarde lo que le llega",
            "Cuentas y accesos para tus clientes",
            "Conexiones con tus otras herramientas y servicios",
            "Un diseño único, con archivos de marca a tu nombre",
            "Configuración del Perfil de Negocio de Google",
            "Correcciones y respuestas prioritarias",
        ],
        packages: [
            {
                id: "basic",
        ...
        addons: [
            {
                ...
                points: [
                    "Reclamo y lleno tu Perfil de Negocio de Google",
                    "Tu nombre, dirección y teléfono coinciden donde sea que aparezcas",
                    "Un acceso de un clic para que tus clientes dejen una reseña",
                ],
                cta: "Pregunta por la configuración SEO",
            },
            {
                id: "seo-care",
                name: "Cuidado SEO",
                ...
                points: [
                    "Tu perfil siempre al día",
                    "Ayuda para responder reseñas",
                    "Un reporte mensual de las llamadas, clics e indicaciones que generó",
                ],
                caveat: "Sin escribir artículos, sin comprar enlaces, y nadie te puede prometer honestamente una posición en Google.",
